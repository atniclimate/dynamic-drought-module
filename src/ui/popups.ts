 ...
 * or NWS sense. The prior wording ("gusting") was never the issuer's word
 * and is corrected here to the NWCG term; `windGustDirection` (WindDirPeak)
 * is fetched but was never rendered before this task and now appears
 * beside the peak speed when the service serves one.
 */
