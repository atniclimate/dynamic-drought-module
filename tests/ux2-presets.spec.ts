...
test.describe('UX-2 view presets', () => {
  ...
  test('the Fire risk preset swaps the surface off NADM to fire weather', async ({ page }) => {
    ...
    // Settle NADM's boot activation so the preset swap that turns it off is
    ...
    // The URL settles to the preset's set: fire weather in, NADM out. The
